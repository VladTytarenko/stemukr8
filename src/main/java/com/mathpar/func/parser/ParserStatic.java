...
final class ParserStatic {
    ...
    static final List<Pattern> PATTERNS_STATIC;
    static final List<TokenType> TYPES_STATIC;
    /**
     * SYMBOLIC tokens end with these patterns
     */
    static final List<Pattern> PATTERNS_SYMB_STATIC;
    static final int VAR_INSERT_INDEX = 4;

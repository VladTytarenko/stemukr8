...
//import com.mathpar.students.student.lukashin.TryGetSumProgress;
//import com.mathpar.students.student.lukashin.Sum;
...
//import com.mathpar.students.student.kireev.TropicalProblems;
//import com.mathpar.students.student.kireev.equation;
//import com.mathpar.students.student.titov.SolveLEX;
...
//                    }
        ...
        switch (nameF) {
            ...
            case F.MULTIPLY:
               ...
               return (fll)? new F(F.MULTIPLY_NC,substituteArg): conectPolynomsMUL(substituteArg);
            // формируем деление
            case F.DIVIDE:

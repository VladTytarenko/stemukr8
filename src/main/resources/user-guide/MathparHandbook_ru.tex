...
\input{ru/00introd.tex}
\input{ru/01znak.tex}
\input{ru/02plot.tex}  
\input{ru/03paradigma}
\input{ru/04funk1var.tex}
\input{ru/05series.tex}
\input{ru/06dequation.tex}
\input{ru/07polynomial.tex}
\input{ru/08matrix.tex}
\input{ru/09mstv.tex}
\input{ru/10procedure.tex}
\input{ru/11TropicMath.tex}
\input{ru/12superComp.tex}
\input{ru/13operators.tex}
\input{ru/physics.tex}
\vfill
\thispagestyle{empty}
\end{document}

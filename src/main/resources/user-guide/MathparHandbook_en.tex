...
\input{en/00introd.tex}
\input{en/01znak.tex}
\input{en/02plot.tex}
\input{en/03paradigma}
\input{en/04funk1var.tex}
\input{en/05series.tex}
\input{en/06dequation.tex}
\input{en/07polynomial.tex}
\input{en/08matrix.tex}
\input{en/09mstv.tex}
\input{en/10procedure.tex}
\input{en/11TropicMath.tex}
\input{en/12superComp.tex}
\input{en/13operators.tex}
\input{en/T01-physics.tex}
%\input{en/T02-physicsHebr.tex}
%\input{en/T03-mathHebr.tex}
\end{document}
